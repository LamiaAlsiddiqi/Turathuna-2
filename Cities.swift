    ...
    let citys : [CityModel] = [
       //city 1
        ...
        .init(
            ...
            places: [
                // place 1
                .init(namePlace: "Farasan Island", image: "Farasan", location: "a", des: "People from Arabia, Africa, and Europe have been drawn to Jazan Province since the first millennium B.C. Throughout the centuries, many people have passed through Farasan and left behind evidence of their societies, including the Aksumites and Arabs. As a result of the strategic location of Jazan Province, including the Farasan Islands, the Germans built a fort on one of the archipelago's islands during World War II. One of the main sites on the island is the sandstone village of Al Qassar, which is said to date back to the time of the Romans. It is no longer inhabited, and it has been completely rebuilt to host tourists. ", landMarks: [.init(name: "AlRifai House", image: "AlRafea", des: "A centerpiece of Jazan province’s Farasan Island is Al-Rifai House, a beautiful palatial building belonging to Ahmed Munawar Al-Rifai. An architectural masterpiece, it features many luxurious inscriptions and decorations that reflect the region’s rich history and civilization. It Majlis (reception area) walls are beautifully decorated with colorful geometric patterns, prominent inscriptions and Qur’anic verses. It was specially constructed using local materials except for stained glass and ceiling timber imported from outside the Kingdom. The interior design featuring engraved and stucco decorations is similar to that found in India and Yemen.", location: "1"), .init(name: "AlNajdi Mosque", image: "AlNajdi", location: "a"), .init(name: "Ottman Fort", image: "Qalaa", location: "a")])
            ]
